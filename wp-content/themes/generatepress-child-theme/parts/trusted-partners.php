    ...
    <div class="z-10 relative">
        <div class="w-full">
            <div class="w-full">
                ...
                <!-- Content Section -->
                <div class="px-10 pt-[60px] trusted-header">
                ...
                <div class="pt-10 md:pt-8 pb-[60px] md:pb-[120px] w-full">
                        ...
                        ?>
                                <div class="rounded-[50px] trusted-slider-item">
                                    <div class="group block h-full">
                                        <div
                                            class="relative flex flex-col justify-end gap-2.5 shadow pt-5 pb-0! rounded-[50px] h-full min-h-[480px] overflow-hidden transition-all duration-500"
                                            style="background: url('<?php echo esc_url($trusted_image['url']); ?>') center / cover no-repeat;">
                                            <!-- Black overlay (BEHIND text) -->
                                            <!-- <div class="z-0 absolute inset-0 bg-black/70"></div> -->

                                            <!-- Title & Content (ABOVE overlay) -->
                                            <div class="z-10 relative flex items-center bg-black/80 p-4">
                                                <div class="w-full transition-transform translate-y-4 group-hover:translate-y-0 duration-500 transform">
                                                    <div class="text-white trusted-content">
                                                        <?php if ($trusted_name): ?>
                                                        ...
                                                        <?php if ($trusted_comment): ?>
                                                            <div class="font-normal text-[24px]">
