...
<div class="bg-white w-full">
    <div class="flex flex-wrap lg:flex-nowrap justify-between mx-auto px-4 py-10 max-w-7xl">
        ...
        <a href="https://x.com/wyzcreations" target="_blank" rel="noopener noreferrer"
            class="flex justify-center py-4 w-1/2 md:w-1/3 lg:w-1/6 text-wyz-creations-guest-black-chalk/75 hover:text-[#000000] hover:scale-110 transition-all duration-400 ease-out transform">
            <svg role="img" class="fill-current w-12 h-12" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                <title>X</title>
        ...
        <a href="https://www.instagram.com/wyzcreations/" target="_blank" rel="noopener noreferrer"
            class="flex justify-center py-4 w-1/2 md:w-1/3 lg:w-1/6 text-wyz-creations-guest-black-chalk/75 hover:text-[#C13584] hover:scale-110 transition-all duration-400 ease-out transform">
            <svg role="img" class="fill-current w-12 h-12" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
        ...
        <a href="https://uk.pinterest.com/wyzcreations/" target="_blank" rel="noopener noreferrer"
            class="flex justify-center py-4 w-1/2 md:w-1/3 lg:w-1/6 text-wyz-creations-guest-black-chalk/75 hover:text-[#E60023] hover:scale-110 transition-all duration-400 ease-out transform">
            <svg role="img" class="fill-current w-12 h-12" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
